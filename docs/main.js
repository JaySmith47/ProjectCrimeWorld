...
var ASM_CONSTS = {
 ...
 106722: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106790: () => { document.exitFullscreen(); },  
 106817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106890: () => { if (document.fullscreenElement) return 1; },  
 106936: () => { return document.getElementById('canvas').width; },  
 106988: () => { return screen.width; },  
 107013: () => { document.exitFullscreen(); },  
 107040: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107173: () => { if (document.fullscreenElement) return 1; },  
 107219: () => { return document.getElementById('canvas').width; },  
 107271: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107339: () => { if (document.fullscreenElement) return 1; },  
 107385: () => { return document.getElementById('canvas').width; },  
 107437: () => { return screen.width; },  
 107462: () => { if (document.fullscreenElement) return 1; },  
 107508: () => { return document.getElementById('canvas').width; },  
 107560: () => { return screen.width; },  
 107585: () => { document.exitFullscreen(); },  
 107612: () => { if (document.fullscreenElement) return 1; },  
 107658: () => { return document.getElementById('canvas').width; },  
 107710: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107778: () => { document.exitFullscreen(); },  
 107805: () => { return screen.width; },  
 107830: () => { return screen.height; },  
 107856: () => { return window.screenX; },  
 107883: () => { return window.screenY; },  
 107910: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107963: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108034: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108091: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108162: () => { if (document.fullscreenElement) return 1; },  
 108208: () => { if (document.pointerLockElement) return 1; }
};
